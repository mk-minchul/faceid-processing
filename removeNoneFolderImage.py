...
for folder in testingFolder:
    if folder not in trainingFolder:
        print(f'{folder} not in training')
        print('list:')
        print(os.listdir(os.path.join(testing, folder)))
        shutil.rmtree(os.path.join(testing, folder))
...
for folder in validationFolder:
    if folder not in trainingFolder:
        print(f'{folder} not in training')
        print('list:')
        print(os.listdir(os.path.join(validation, folder)))
        shutil.rmtree(os.path.join(validation, folder))
