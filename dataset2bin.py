...
parser.add_argument('--file-pairs', default='', help='path to file pairs.')
args = parser.parse_args()
lfw_dir = args.dataset_dir
file_pairs = args.file_pairs
image_size = [int(x) for x in args.image_size.split(',')]
lfw_pairs = lfw.read_pairs(os.path.join(lfw_dir, f'{file_pairs}'))
lfw_paths, issame_list = lfw.get_paths(lfw_dir, lfw_pairs, 'jpg') # or jpg
print(f'len lfw_paths {len(lfw_paths)}')
lfw_bins = []
